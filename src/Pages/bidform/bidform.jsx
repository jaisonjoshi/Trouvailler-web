    ...
    return (
        <div className="">
            ...
            <form action="" className="">
                <div className="m-10">
                    <div className="flex mid:mx-10 border text-graydust-normal rounded-lg w-72 md:w-1/2 h-10">
                        <img src={require('../Assets/Location.png')} alt="" className="h-5 w-5 my-auto mx-4" />
                        <select name="location" id="location" className="outline-none text-gray text-graydust-normal">
                    ...
                    <div className="md:flex my-10">
                        <div className="flex border text-graydust-normal rounded-lg w-72 h-10">
                            <img src={require('../Assets/Categories.png')} alt="" className="h-5 w-5 my-auto mx-4" />
                            <select name="categories" id="categories" className="outline-none text-graydust-normal">
                        ...
                        <div className="md:my-auto my-7">
                            ...
                            <label for="ac" className="md:ml-5 text-graydust-normal">AC</label>
                    ...
                    <div className="md:flex">
                        ...
                        <div className="flex md:mx-10 md:my-0 my-7 border text-graydust-normal rounded-lg w-72 h-10">
                    ...
                    <div className="md:flex">
                        <div className="my-5">
                            <label for="ac" className="text-graydust-normal">Min</label>
                            <input type="text" id="min_budget" name="budget" value="" placeholder="₹1000" className="ml-5 text-center outline-none border text-graydust-normal w-44 h-10 rounded-xl" />
                        </div>
                        <div className="sm:my-5">
                            <label for="ac" className="md:ml-10 text-graydust-normal">Max</label>
                            <input type="text" id="min_budget" name="budget" value="" placeholder="₹3000" className="ml-5 text-center outline-none border text-graydust-normal w-44 h-10 rounded-xl" />
                        </div>
                    </div>

                    <div className="flex justify-between my-5">
                        <input type="reset" value="Reset" className="mr-10 outline-none border border-graydust-normal hover:text-whiteglow text-graydust-normal hover:bg-blacky-dark h-10 w-44 text-center rounded-xl " />
