    ...
    <header class="text-blacky-light body-font">
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div className="md:flex my-4">
          <input type="text" className="w-20 bg-whiteglow outline-none text-blacky-dark text-sm border border-graydust-normal duration-500 px-4 py-2 mx-4 rounded-md border border-none focus:ring-0 focus:ring-offset-0" placeholder="Search" />
